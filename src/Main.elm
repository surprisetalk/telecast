...
type
    ViewState
    -- TODO: We should store { channel : Maybe (Url, Loadable Feed), search : Maybe SearchState } in the Model and derive the view states instead.
    = ViewMyFeed
...
findSelectedEpisode model =
    -- TODO: We need to drastically simplify this.
    model.episode
        |> Maybe.andThen
            (\episodeId ->
                case model.view of
